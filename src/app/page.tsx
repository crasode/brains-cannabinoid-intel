      ...
      <section className="px-8 py-10 md:px-14">
        ...
        <Reveal className="mt-6">
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="border border-black/5 bg-white p-6"><div className="text-xs uppercase tracking-[0.16em] text-[#7a8794]">Daily tracking</div><div className="mt-3 text-3xl font-[family-name:var(--font-serif)] text-[#0d2035]">{data.changesSummary.newlyAdded}</div><p className="mt-2 text-sm leading-7 text-[#526174]">New studies added in the last 14 days.</p></div>
            <div className="border border-black/5 bg-white p-6"><div className="text-xs uppercase tracking-[0.16em] text-[#7a8794]">Recent movement</div><div className="mt-3 text-3xl font-[family-name:var(--font-serif)] text-[#0d2035]">{data.changesSummary.recentlyUpdated}</div><p className="mt-2 text-sm leading-7 text-[#526174]">Studies updated in the last 14 days.</p></div>
            <div className="border border-black/5 bg-white p-6"><div className="text-xs uppercase tracking-[0.16em] text-[#7a8794]">High-scoring pool</div><div className="mt-3 text-3xl font-[family-name:var(--font-serif)] text-[#0d2035]">{data.changesSummary.highScoreCount}</div><p className="mt-2 text-sm leading-7 text-[#526174]">Indexed studies currently scoring 70+.</p></div>
          </div>
        </Reveal>
